...
(function () {
  ...
  const DICT = {
    ...
    'เมนูหลัก': 'Main menu', 'สำหรับผู้ดูแล': 'For admins',
    'บทเรียนที่เรียนจบ': 'Lessons completed', 'ข้อสอบที่สอบผ่าน': 'Quizzes passed', 'ใบประกาศที่ได้รับ': 'Certificates earned',
    'ความคืบหน้า': 'Progress', 'ผ่านเกณฑ์': 'Passed', 'ใบ': 'certs',
    '📋 งานที่ได้รับมอบหมาย': '📋 Assigned work', '📝 คะแนนที่ทำได้': '📝 My scores', '🏆 ใบประกาศที่ได้รับ': '🏆 My certificates',
    'ยังไม่มีงานที่ได้รับมอบหมาย': 'No assigned work yet', 'ยังไม่มีผลสอบ': 'No quiz results yet',
    'เปิด/พิมพ์': 'Open/Print', '✓ เสร็จแล้ว': '✓ Done', 'ยังไม่เสร็จ': 'Not done', 'ปิด': 'Close', '(ไม่พบรายการ)': '(item not found)',
    'ผู้ดูแลระบบ · ยินดีต้อนรับกลับมา': 'Administrator · Welcome back',
    'ยินดีต้อนรับสู่ระบบอบรมและทดสอบออนไลน์': 'Welcome to the online training & testing system',
    'เรียนรู้ผ่านวิดีโอ สไลด์ และเนื้อหา': 'Learn via video, slides and content',
    'ประเมินความรู้ของคุณ': 'Assess your knowledge',
    'ฝึกความเร็วและความแม่นยำในการพิมพ์': 'Practice typing speed & accuracy',
    'ดูผลสอบและสถิติทั้งหมด': 'View all results & stats',
    'มอบหมายบทเรียน/แบบทดสอบให้ทีม': 'Assign lessons/quizzes to teams',
    'เพิ่ม แก้ไข รีเซ็ตบัญชีผู้ใช้': 'Add, edit, reset user accounts',
    // บทเรียน
    ...
    '🇹🇭 ภาษาไทย': '🇹🇭 Thai', '▶ ยังไม่เคยทำ — เริ่มเลย': '▶ Not attempted — start now',
    ...
    'จัดการบทเรียนและข้อสอบ': 'Manage Lessons & Quizzes', '📘 บทเรียน': '📘 Lessons', '📝 แบบทดสอบ': '📝 Quizzes',
    '+ เพิ่มแบบทดสอบใหม่': '+ Add new quiz', '➕ เพิ่มบทเรียนใหม่': '➕ Add new lesson', '✏️ แก้ชื่อบทเรียน': '✏️ Rename lesson',
    'สร้างแล้วแก้เนื้อหา': 'Create & edit content', 'บันทึกชื่อ': 'Save name', 'ยกเลิก': 'Cancel',
    'หมวด / Section': 'Category / Section', 'ชื่อชุดข้อสอบ': 'Quiz name', 'จำนวนข้อ': 'Questions', 'เกณฑ์ผ่าน': 'Pass mark',
    'แก้ไขข้อสอบ': 'Edit quiz', 'เพิ่มข้อสอบใหม่': 'Add new quiz', 'แก้ไขข้อสอบ ': 'Edit quiz',
    'เวลา (นาที)': 'Time (min)', 'เกณฑ์ผ่าน (%)': 'Pass mark (%)', 'ไม่มีแบบทดสอบ': 'No quizzes',
    'ตัวเลือก (บรรทัดละ 1 ข้อ)': 'Choices (one per line)', 'คำถาม': 'Question',
    '+ เพิ่มคำถาม': '+ Add question', '💾 บันทึกข้อสอบ': '💾 Save quiz',
    'กรุณาใส่ชื่อชุดข้อสอบ': 'Please enter a quiz name', 'ต้องมีอย่างน้อย 1 คำถาม': 'At least 1 question required',
    'บันทึกข้อสอบเรียบร้อย ✓': 'Quiz saved ✓', 'ข้อที่ถูก (ลำดับตัวเลือก 1-N):': 'Correct choice (1-N):',
  ...
  const RULES = [
    ...
    [/^(\d+) ข้อ$/, '$1 questions'],
    [/^(\d+) นาที$/, '$1 min'],
    [/^บทเรียน · กำหนดส่ง (.+)$/, 'Lesson · Due $1'],
    [/^แบบทดสอบ · กำหนดส่ง (.+)$/, 'Quiz · Due $1'],
    [/^แบบทดสอบ · ทำไปแล้ว (\d+) ครั้ง$/, 'Quiz · Attempted $1×'],
    [/^แบบทดสอบ · ทำไปแล้ว (\d+) ครั้ง · ดีสุด (\d+(?:\.\d+)?)%$/, 'Quiz · Attempted $1× · Best $2%'],
    [/^กำหนดส่ง (.+)$/, 'Due $1'],
    [/^· (\d+) รายการ$/, '· $1 shown'],
    [/^หน้า (\d+) \/ (\d+)$/, 'Page $1 / $2'],
